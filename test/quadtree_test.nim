...
suite "Quadtrees should":
    ...
    test "Add and fetch a single bounding box":
        ...
        tree.insert( box )
        require(tree.bounds.get == (top: -1, left: -1, size: 32))
    ...
    test "Adding to a tree without subdividing":
        ...
        tree.insert( box1 )
        tree.insert( box2 )
        require(tree.bounds.get == (top: 0, left: 0, size: 32))
    ...
    test "Subdividing a leaf node after it gets full":
        ...
        tree.insert( box1 )
        tree.insert( box2 )
        require(tree.bounds.get == (top: -1, left: -1, size: 16))
    ...
    test "Expand the until it fits the new element":
        ...
        require(tree.bounds.get == (top: -174756, left: -174758, size: 524288))
    ...
    test "Fetching from an empty quadrant":
        ...
        require(tree.bounds.get == (top: 0, left: 0, size: 16))
